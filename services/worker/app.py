...
def process_document_task(self, doc_id: int):
    ...
    try:
        ...
        send_ws_notification(user_id, {
            ...
            "message": "Extracting dates, emails, and amounts"
        })
        ...
        if self.request.retries < self.max_retries:
            ...
            if doc:
                ...
                # Notify: Retrying
                send_ws_notification(doc.owner_id, {
                    "type": "retrying",
                    "doc_id": doc_id,
                    "retry": retry_count,
                    "max_retries": self.max_retries,
                    "message": f"Retry attempt {retry_count} of {self.max_retries}"
                })
